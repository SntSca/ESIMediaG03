...
public class ContenidoService {
    ...
    public Contenido modificarContenido(Contenido contenido) throws Exception {
        if (contenido.getId() == null) throw new IllegalArgumentException("El ID del contenido es obligatorio para modificar.");
        Contenido existente = contenidoDAO.findById(contenido.getId())
            .orElseThrow(() -> new IllegalArgumentException("No existe contenido con ID: " + contenido.getId()));
