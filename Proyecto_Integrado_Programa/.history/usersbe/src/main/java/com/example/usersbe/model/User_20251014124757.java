...
public class User {
    ...
    // NUEVO: enum para el tipo de contenido del Gestor
    ...
    // IMPORTANTE: index único para alias
    @Indexed(unique = true)
    ...
    // Campos de Gestor de Contenido (opcionales salvo si role=GESTOR_CONTENIDO)
    private String descripcion;
    private String especialidad;
    private TipoContenido tipoContenido; // AUDIO o VIDEO
