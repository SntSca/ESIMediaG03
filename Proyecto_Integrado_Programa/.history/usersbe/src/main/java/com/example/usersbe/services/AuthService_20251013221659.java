...
public class AuthService {
    ...
    private static final String DUMMY_BCRYPT = org.mindrot.jbcrypt.BCrypt.hashpw("DUMMY_PASSWORD_SECURE_!23", org.mindrot.jbcrypt.BCrypt.gensalt());
...
public User login(String email, String rawPassword) {
    ...
    if (u == null) {
        encoder.matches(DUMMY_PASSWORD, DUMMY_BCRYPT);
