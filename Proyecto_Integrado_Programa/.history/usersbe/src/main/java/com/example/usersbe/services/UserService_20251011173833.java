...
public class UserService {
    ...
    public void registrar(UserRegistrationRequest request) throws UserAlreadyExistsException {
        final String emailN = (request.email == null) ? "" : request.email.trim().toLowerCase();
        if (this.userDao.findByEmail(emailN) != null) {
            throw new UserAlreadyExistsException("El usuario ya existe");
        }

        String pwdEncriptada = org.mindrot.jbcrypt.BCrypt.hashpw(request.pwd, org.mindrot.jbcrypt.BCrypt.gensalt());
        ...
        user.setFechaNac(LocalDate.parse(request.fechaNac));
