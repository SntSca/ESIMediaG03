...
public class UserService {
    ...
    /* ===== Registro =====
       Se exige: alias obligatorio y único, foto obligatoria.
       Si role = GESTOR_CONTENIDO: descripcion, especialidad y tipoContenido obligatorios.
    */
    public void registrar(String nombre, String apellidos, String alias, String email,
        ...
        // Validaciones específicas de Gestor de Contenido
    ...
    // Construye el usuario incluyendo campos de Gestor cuando aplique
