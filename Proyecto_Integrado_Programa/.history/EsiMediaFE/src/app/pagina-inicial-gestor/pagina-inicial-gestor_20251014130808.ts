...
export class PaginaInicialGestor implements OnInit {
  ...
  // Iniciales por si no hay foto o falla la carga
  userInitials = this.getInitials(this.userName);

  // NUEVO: url de la foto del usuario (si existe)
  ...
  private setLoggedUser(user: UserDto | null) {
    ...
    // NUEVO: coger foto del dto si existe
  ...
  // Si la imagen falla, volvemos a mostrar las iniciales
  onAvatarError(): void {
    this.userAvatarUrl = null;
  }

  // ------------------- (tu lógica existente abajo sin cambios) -------------------
